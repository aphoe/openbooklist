...
Changes on the `dev` branch that have not yet been pushed to the remote
(9 commits, 2026-09-03 – 2026-09-04, since tag `1.6.0`).
...
[Unreleased]: https://github.com/aphoe/openbooklist/compare/1.6.0...dev
[1.6.0]: https://github.com/aphoe/openbooklist/compare/1.5.0...1.6.0
[1.5.0]: https://github.com/aphoe/openbooklist/compare/1.4.1...1.5.0
[1.4.1]: https://github.com/aphoe/openbooklist/compare/1.4.0...1.4.1
[1.4.0]: https://github.com/aphoe/openbooklist/compare/v1.3.0...1.4.0
[1.3.0]: https://github.com/aphoe/openbooklist/compare/v1.2.0...v1.3.0
[1.2.0]: https://github.com/aphoe/openbooklist/compare/v1.1.0...v1.2.0
[1.1.0]: https://github.com/aphoe/openbooklist/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/aphoe/openbooklist/releases/tag/v1.0.0
