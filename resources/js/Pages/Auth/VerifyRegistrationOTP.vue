            ...
            <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12 dark:bg-[#1e293b] border border-slate-200 dark:border-slate-800 text-center">
                ...
                <div class="flex items-center justify-center mb-6">
                    <div class="p-3 bg-primary/10 rounded-xl">
                        <span class="material-symbols-outlined text-primary text-3xl block">mark_email_read</span>
                    </div>
                </div>

                <h1 class="text-slate-900 dark:text-white text-2xl font-bold tracking-tight">Verify Your Email</h1>
                
                <div class="mt-2 text-slate-500 dark:text-slate-400 text-sm flex flex-col justify-center">
                    <span>We sent a 6-digit code to <span class="font-medium text-slate-900 dark:text-slate-200">{{ email }}</span></span>
                </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        ...
                        <Link :href="route('verification.send')" method="post" as="button" class="font-semibold leading-6 text-primary hover:text-primary/80 transition-colors ml-1">
                            Resend Code
                        </Link>
                    </p>
                </div>
