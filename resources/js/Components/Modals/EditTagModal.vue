            ...
            <div v-if="show" class="fixed inset-0 z-50 flex items-start justify-center pt-16 px-4">
                ...
                <div
                    ...
                    <div class="flex items-center justify-between p-5 border-b border-slate-100 dark:border-slate-800">
                        <h2 class="text-lg font-bold text-slate-900 dark:text-white">Edit Tag</h2>
                        <button type="button"
                    ...
                    <form @submit.prevent="submit" class="p-5 space-y-4">
                        <div>
                            ...
                            <TextInput v-model="form.name" placeholder="Tag Name" />
                        ...
                        <ModalActionButtons :processing="form.processing" submit-text="Save Changes" submit-icon="save"
                            @cancel="close" />
                    </form>
                </div>
            </div>
